    ...
    return (
            <div className='page' id='projects'>
                ...
                <div className ="cards">
                    ...
                    <Card id = "stats" title = "Apex Legends Stat Tracker" imgSrc = {apex} linksArray = {[<img key='10' src={github} alt="" width="35px"/>, <img key='11' src={link} width="40px"alt=""/>]} techArray = "React&emsp;Express/Node.js&emsp;tracker.gg API" modalTarget = "#stats"/>
